...
namespace TransactionService.Client.Infrastructure.Consul;
...
public static class ConsulExtensions
{
    public static IApplicationBuilder UseConsul(this IApplicationBuilder app)
    {
        ...
        var serviceConfig = app.ApplicationServices.GetRequiredService<IOptions<TransactionService.Common.ServiceDiscovery.Consul.ServiceConfig>>().Value;
