...
namespace TransactionService.Client.Infrastructure.HealthChecks;
...
public static class HealthCheckExtensions
{
        ...
        IConfiguration configuration)
    {
        services.AddHealthChecks()
            ...
            .AddNpgSql(
                ...
                tags: new[] { "database", "postgresql", "transactiondb" }
            )
            .AddElasticsearch(
    ...
    public static WebApplication MapWebMtsHealthChecks(this WebApplication app)
    {
        ...
        app.MapHealthChecks("/api/transaction/health/ready", new HealthCheckOptions
        {
        ...
        app.MapHealthChecks("/api/transaction/health/live", new HealthCheckOptions
        {
