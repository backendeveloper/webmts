...
namespace NotificationService.Client.Infrastructure.Vault;
...
public static class VaultExtensions
{
    ...
    public static async Task<IConfigurationBuilder> AddVaultConfiguration(this IConfigurationBuilder builder, IConfiguration configuration)
    {
        ...
        try
        {
            var jwtSecrets = await secretManager.GetSecretAsync("webmts/notification/jwt");
            ...
            var dbSecrets = await secretManager.GetSecretAsync("webmts/notification/db");
