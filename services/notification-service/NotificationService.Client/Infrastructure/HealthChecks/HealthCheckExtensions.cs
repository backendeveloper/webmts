...
namespace NotificationService.Client.Infrastructure.HealthChecks;
...
public static class HealthCheckExtensions
{
        ...
        IConfiguration configuration)
    {
        services.AddHealthChecks()
            ...
            .AddNpgSql(
                ...
                tags: ["database", "postgresql", "notificationdb"]
            )
            .AddElasticsearch(
    ...
    public static WebApplication MapWebMtsHealthChecks(this WebApplication app)
    {
        ...
        app.MapHealthChecks("/api/notification/health/ready", new HealthCheckOptions
        {
        ...
        app.MapHealthChecks("/api/notification/health/live", new HealthCheckOptions
        {
