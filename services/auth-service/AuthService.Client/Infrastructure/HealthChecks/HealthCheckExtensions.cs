...
namespace AuthService.Client.Infrastructure.HealthChecks;
...
public static class HealthCheckExtensions
{
        ...
        IConfiguration configuration)
    {
        services.AddHealthChecks()
            ...
            .AddNpgSql(
                ...
                name: "authdb-check",
                tags: new[] { "database", "postgresql", "authdb" }
            )
            .AddRedis(
                configuration.GetSection("CacheSettings:DistributedCache:ConnectionString").Value ?? string.Empty,
                name: "redis-check",
    ...
    public static WebApplication MapWebMtsHealthChecks(this WebApplication app)
    {
        ...
        app.MapHealthChecks("/api/auth/health/ready", new HealthCheckOptions
        {
        ...
        app.MapHealthChecks("/api/auth/health/live", new HealthCheckOptions
        {
